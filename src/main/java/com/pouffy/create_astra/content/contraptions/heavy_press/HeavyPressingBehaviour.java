...
public class HeavyPressingBehaviour extends BeltProcessingBehaviour {
	...
	public <T extends SmartTileEntity & PressingBehaviourSpecifics> HeavyPressingBehaviour(T te) {
		super(te);
		this.specifics = te;
		mode = Mode.WORLD;
		entityScanCooldown = ENTITY_SCAN;
		whenItemEnters((s, i) -> BeltHeavyPressingCallbacks.onItemReceived(s, i, this));
		whileItemHeld((s, i) -> BeltHeavyPressingCallbacks.whenItemHeld(s, i, this));
	}
