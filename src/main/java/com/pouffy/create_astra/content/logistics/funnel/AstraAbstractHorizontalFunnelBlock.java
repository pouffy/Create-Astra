...
public abstract class AstraAbstractHorizontalFunnelBlock extends AstraAbstractFunnelBlock {
	public static final DirectionProperty HORIZONTAL_FACING = BlockStateProperties.HORIZONTAL_FACING;

	protected AstraAbstractHorizontalFunnelBlock(BlockBehaviour.Properties p_i48377_1_) {
		super(p_i48377_1_);
	}
